...
{$IFDEF LAZARUS}
const
  META_SETBKCOLOR            = $00000201;
  META_SETBKMODE             = $00000102;
  META_SETMAPMODE            = $00000103;
  META_SETROP2               = $00000104;
  META_SETRELABS             = $00000105;
  META_SETPOLYFILLMODE       = $00000106;
  META_SETSTRETCHBLTMODE     = $00000107;
  META_SETTEXTCHAREXTRA      = $00000108;
  META_SETTEXTCOLOR          = $00000209;
  META_SETTEXTJUSTIFICATION  = $0000020A;
  META_SETWINDOWORG          = $0000020B;
  META_SETWINDOWEXT          = $0000020C;
  META_SETVIEWPORTORG        = $0000020D;
  META_SETVIEWPORTEXT        = $0000020E;
  META_OFFSETWINDOWORG       = $0000020F;
  META_SCALEWINDOWEXT        = $00000410;
  META_OFFSETVIEWPORTORG     = $00000211;
  META_SCALEVIEWPORTEXT      = $00000412;
  META_LINETO                = $00000213;
  META_MOVETO                = $00000214;
  META_EXCLUDECLIPRECT       = $00000415;
  META_INTERSECTCLIPRECT     = $00000416;
  META_ARC                   = $00000817;
  META_ELLIPSE               = $00000418;
  META_FLOODFILL             = $00000419;
  META_PIE                   = $0000081A;
  META_RECTANGLE             = $0000041B;
  META_ROUNDRECT             = $0000061C;
  META_PATBLT                = $0000061D;
  META_SAVEDC                = $0000001E;
  META_SETPIXEL              = $0000041F;
  META_OFFSETCLIPRGN         = $00000220;
  META_TEXTOUT               = $00000521;
  META_BITBLT                = $00000922;
  META_STRETCHBLT            = $00000B23;
  META_POLYGON               = $00000324;
  META_POLYLINE              = $00000325;
  META_ESCAPE                = $00000626;
  META_RESTOREDC             = $00000127;
  META_FILLREGION            = $00000228;
  META_FRAMEREGION           = $00000429;
  META_INVERTREGION          = $0000012A;
  META_PAINTREGION           = $0000012B;
  META_SELECTCLIPREGION      = $0000012C;
  META_SELECTOBJECT          = $0000012D;
  META_SETTEXTALIGN          = $0000012E;
  META_CHORD                 = $00000830;
  META_SETMAPPERFLAGS        = $00000231;
  META_EXTTEXTOUT            = $00000a32;
  META_SETDIBTODEV           = $00000d33;
  META_SELECTPALETTE         = $00000234;
  META_REALIZEPALETTE        = $00000035;
  META_ANIMATEPALETTE        = $00000436;
  META_SETPALENTRIES         = $00000037;
  META_POLYPOLYGON           = $00000538;
  META_RESIZEPALETTE         = $00000139;
  META_DIBBITBLT             = $00000940;
  META_DIBSTRETCHBLT         = $00000b41;
  META_DIBCREATEPATTERNBRUSH = $00000142;
  META_STRETCHDIB            = $00000f43;
  META_EXTFLOODFILL          = $00000548;
  META_DELETEOBJECT          = $000001f0;
  META_CREATEPALETTE         = $000000f7;
  META_CREATEPATTERNBRUSH    = $000001F9;
  META_CREATEPENINDIRECT     = $000002FA;
  META_CREATEFONTINDIRECT    = $000002FB;
  META_CREATEBRUSHINDIRECT   = $000002FC;
  META_CREATEREGION          = $000006FF;
...
\**************************************************************************)
  ...
  IGPPathData = interface
    ...
    function GetPoints() : PGPPointF;
    function GetTypes()  : PBYTE;

    property Count  : Integer   read GetCount;
    property Points : PGPPointF read GetPoints;
    property Types  : PBYTE     read GetTypes;
...
\**************************************************************************)
  ...
  IGPLinearGradientBrush = interface( IGPBlendBrush )
    ...
    function  SetInterpolationColorsArrays( presetColors: array of TGPColor; blendPositions: array of Single ) : TGPLinearGradientBrush;
...
//--------------------------------------------------------------------------
  ...
  IGPPathGradientBrush = interface( IGPBlendBrush )
    ...
    function  SetInterpolationColorsArrays( presetColors: array of TGPColor; blendPositions: array of Single ) : TGPPathGradientBrush;
...
\**************************************************************************)
  ...
  IGPGraphics = interface
    ...
    // DrawRectangle(s)
    function DrawRectangleF(pen: IGPPen; const rect: TGPRectF) : TGPGraphics; overload;
    ...
    function DrawRectangle(pen: IGPPen; const rect: TGPRect) : TGPGraphics; overload;
    ...
    function DrawRectangleF(pen: IGPPen; brush: IGPBrush; const rect: TGPRectF) : TGPGraphics; overload;
    ...
    function DrawRectangle(pen: IGPPen; brush: IGPBrush; const rect: TGPRect) : TGPGraphics; overload;
...
\********************************************************************F******)
  ...
  begin
    SetRemapTable(mapSize, map, ColorAdjustTypeBrush);
    Result := Self;
  end;
...
//    GdipGetImageEncoders(numEncoders, size, @Result[ 0 ] )
    ...
    for j := 0 to num - 1 do
      begin
      if( LowerCase( PGPImageCodecInfo( Cardinal( aImageCodecInfo ) + j * SizeOf( TGPImageCodecInfo )).MimeType ) = format ) then
        begin
        pClsid := PGPImageCodecInfo( Cardinal( aImageCodecInfo ) + j * SizeOf( TGPImageCodecInfo )).Clsid;
...
\**************************************************************************)
  ...
  begin
    ErrorCheck( GdipCombineRegionRectI(FNativeRegion, @rect,
  ...
  begin
    ErrorCheck( GdipCombineRegionRect(FNativeRegion, @rect,
                                                       CombineModeComplement));
...
\**************************************************************************)
  ...
  begin
    ...
    ErrorCheck( GdipGetPenColor(FNativePen, argb));
    Result := argb;
  end;
...
//--------------------------------------------------------------------------
  ...
  begin
    ErrorCheck( GdipSetSolidFillColor(GpSolidFill(FNativeBrush),
                color));
...
//--------------------------------------------------------------------------
  ...
  begin
    ErrorCheck( GdipRotateTextureTransform(GpTexture(FNativeBrush),
                                                              angle, order));
...
//--------------------------------------------------------------------------
  ...
  function TGPLinearGradientBrush.SetInterpolationColorsArrays( presetColors: array of TGPColor; blendPositions: array of Single ) : TGPLinearGradientBrush;
  begin
...
\**************************************************************************)
  ...
  begin
    graphics:= nil;
    ErrorCheck( GdipCreateFromHDC(hdc, graphics));
    SetNativeGraphics(graphics);
  end;
  ...
  begin
    graphics:= nil;
    ErrorCheck( GdipCreateFromHDC2(hdc, hdevice, graphics));
    SetNativeGraphics(graphics);
  end;
  ...
  function TGPGraphics.ReleaseHDC(hdc: HDC) : TGPGraphics;
  begin
    ErrorCheck( GdipReleaseDC(FNativeGraphics, hdc));
    Result := Self;
  end;
  ...
  var mode: TGPInterpolationMode;
  begin
    mode := InterpolationModeInvalid;
    ErrorCheck( GdipGetInterpolationMode(FNativeGraphics, mode));
    Result := mode;
  end;
  ...
  var smoothingMode: TGPSmoothingMode;
  begin
    smoothingMode := SmoothingModeInvalid;
    ErrorCheck( GdipGetSmoothingMode(FNativeGraphics,  smoothingMode));
  ...
  var pixelOffsetMode: TGPPixelOffsetMode;
  begin
    pixelOffsetMode := PixelOffsetModeInvalid;
    ErrorCheck( GdipGetPixelOffsetMode(FNativeGraphics, pixelOffsetMode));
  ...
  begin
    ErrorCheck( GdipDrawLine(FNativeGraphics,
                          pen.GetNativePen(), x1, y1, x2,
                          y2));
  ...
  begin
    DrawLineF(pen, pt1.X, pt1.Y, pt2.X, pt2.Y);
    Result := Self;
  end;
  ...
  begin
    DrawArcF(pen, rect.X, rect.Y, rect.Width, rect.Height,
  ...
  function TGPGraphics.DrawRectangleF(pen: IGPPen; const rect: TGPRectF) : TGPGraphics;
  begin
    DrawRectangleF(pen, rect.X, rect.Y, rect.Width, rect.Height);
  ...
  function TGPGraphics.DrawRectangle(pen: IGPPen; const rect: TGPRect) : TGPGraphics;
  begin
    DrawRectangle(pen,
                 rect.X,
                 rect.Y,
  ...
  function TGPGraphics.DrawRectangleF(pen: IGPPen; brush: IGPBrush; const rect: TGPRectF) : TGPGraphics;
  begin
    FillRectangleF( brush, rect );
    DrawRectangleF( pen, rect );
    Result := Self;
  end;
  ...
  begin
    ...
    DrawRectangleF( pen, x, y, width, height );
    Result := Self;
  end;
  ...
  function TGPGraphics.DrawRectangle(pen: IGPPen; brush: IGPBrush; const rect: TGPRect) : TGPGraphics;
  begin
  ...
  begin
    ...
    DrawEllipseF( pen, x, y, width, height );
    Result := Self;
  end;
  ...
  begin
    for I := 0 to Length( rects ) - 1 do
      begin
      FillEllipsesF( brush, rects[ I ] );
      DrawEllipsesF( pen, rects[ I ] );
      end;
  ...
  begin
    for I := 0 to Length( rects ) - 1 do
      begin
      FillEllipses( brush, rects[ I ] );
      DrawEllipses( pen, rects[ I ] );
      end;
  ...
  begin
    ...
    DrawPieF( pen, rect, startAngle, sweepAngle );
    Result := Self;
  end;
  ...
  begin
    ...
    DrawPieF( pen, x, y, width, height, startAngle, sweepAngle );
    Result := Self;
  end;
  ...
  begin
    ...
    DrawClosedCurveF( pen, points, tension );
    Result := Self;
  end;
  ...
  begin
    FillRectangleF(brush, rect.X, rect.Y, rect.Width, rect.Height);
  ...
  begin
    FillEllipseF(brush, rect.X, rect.Y, rect.Width, rect.Height);
    Result := Self;
  end;
  ...
  begin
    FillPieF(brush, rect.X, rect.Y, rect.Width, rect.Height,
               startAngle, sweepAngle);
...
//       out boundingBox: TGPRectF);
  ...
  begin
    DrawImageF(image, point.X, point.Y);
  ...
  begin
    DrawImageF(image, rect.X, rect.Y, rect.Width, rect.Height);
  ...
  begin
    ErrorCheck( GdipTranslateClipI(FNativeGraphics,
                            dx, dy));
  ...
  begin
    ErrorCheck( GdipRestoreGraphics(FNativeGraphics,
                             gstate));
...
\**************************************************************************)
  ...
  begin
    ErrorCheck( GdipAddPathLine(FNativePath, x1, y1,
                                         x2, y2));
    Result := Self;
  end;
  ...
  begin
    AddArcF(rect.X, rect.Y, rect.Width, rect.Height,
                  startAngle, sweepAngle);
  ...
  begin
    AddBezierF(pt1.X, pt1.Y, pt2.X, pt2.Y, pt3.X, pt3.Y, pt4.X, pt4.Y);
    Result := Self;
  end;
  ...
  begin
    AddEllipseF(rect.X, rect.Y, rect.Width, rect.Height);
    Result := Self;
  end;
  ...
  begin
    ...
    ErrorCheck( GdipIsOutlineVisiblePathPoint(FNativePath, x, y, nativePen,
  ...
  begin
    ...
    ErrorCheck( GdipIsOutlineVisiblePathPointI(FNativePath, x, y, nativePen,
       nativeGraphics, booln));
    Result := booln;
  end;
...
//--------------------------------------------------------------------------
  ...
  function TGPPathGradientBrush.SetInterpolationColorsArrays( presetColors: array of TGPColor; blendPositions: array of Single ) : TGPPathGradientBrush;
  begin
    ErrorCheck( GdipSetPathGradientPresetBlend(GpPathGradient(GetNativeBrush()),
                          PGPColor( @presetColors[ 0 ]), @blendPositions[ 0 ], Min( Length( presetColors ), Length( blendPositions ))));
...
// -----------------------------------------------------------------------------
  ...
  function TGPPathData.GetPoints() : PGPPointF;
  begin
    Result := FPoints;
  end;

  function TGPPathData.GetTypes()  : PBYTE;
  begin
    Result := FTypes;
  end;
...
//    Result := MakeColor( AAlpha, GetRValue( AColor ), GetGValue( AColor ), GetBValue( AColor ));
  ...
  function RGBToBGR(color: TGPColor) : TGPColor;
  begin
    Result := MakeColor( GetAlpha( color ), GetRValue(color), GetGValue(color), GetBValue(color) );
  end;
